...
BOT_TOKEN = environ['6657820331:AAFs5VD_70rOmWfQNmhVM8kyqrPWFLfj9oA']

# Bot settings
WEBHOOK = bool(environ.get("WEBHOOK", True)) # for web support on/off
PICS = (environ.get('PICS' ,'https://graph.org/file/01ddfcb1e8203879a63d7.jpg')).split()
UPTIME = time.time()
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://hebapir376:ravi1234@cluster0.x9pmpfx.mongodb.net/?retryWrites=true&w=majority")
...
SHORT_API = environ.get("00b0eacdca74780666d78f22ec43440e43994c2b")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001940288450'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+_K6Abx9DP1g4NTJl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001783989785')).split()]
